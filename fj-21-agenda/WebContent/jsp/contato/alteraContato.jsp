				...
				<form action="adicionaContato" method="post">
					<div class="form-group">
						<label for="nome">nome:</label> <input type="text"
							class="form-control" value="${contatoVO.nome}" id="nome" name="nome">
					</div>

					<div class="form-group">
						<label for="email">Email address:</label> <input type="email"
							class="form-control" id="email" value="${contatoVO.email}" name="email">
					</div>

					<div class="form-group">
						<label for="endereco">Endere̤o:</label> <input type="text"
							class="form-control" id="endereco"  value="${contatoVO.endereco}" name="endereco">
					</div>

					<div class="form-group">
						<label for="data-de-nascimento">Data de Nascimento:</label> 
						<!-- input type="text" class="form-control" id="dataDeNascimento" name="dataDeNascimento"> -->
						<caelum:campoData id="dataNascimento" value="${contatoVO.dataNascimento.time}" />
					</div>
